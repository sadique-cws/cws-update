                ...
                <div class="table-responsive p-2">
                    <table id="example2" class="table p-2 table-borderless table-hover">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex d-print-none">
                                        {{-- <form action="{{ route('set.payment.paid') }}" method="post">
                                            ...
                                            <button data-bs-target="#payment_mode_{{ $due->id }}" data-bs-toggle="modal" class="btn btn-sm bg-light-success text-success">₹ Paid</button>
                                        {{-- </form> --}}
                            ...
                            {{-- payment type & confirmation modal --}}
                            <div class="modal fade" id="payment_mode_{{ $due->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('set.payment.paid') }}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    <select required name="payment_mode" id="pm" class="form-select shadow-none">
                                                        <option value="" selected hidden disabled>select payment mode</option>
                                                        <option value="cash">Cash</option>
                                                        <option value="online">Online</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3 d-flex ms-auto align-items-end">
                                                    <button data-bs-dismiss="modal" class="btn btn-info btn-sm ms-auto">Cancel</button>
                                                    <input type="submit" value="Pay" class="btn ms-2 btn-dark btn-sm">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
