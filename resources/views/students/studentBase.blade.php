        ...
        <div class="w-1/4">
            <div class="bg-white w-full h-screen rounded-lg border border-slate-300">
                <div class="w-full h-64">
                    <div class="bg-[url('https://picsum.photos/400/100')] h-24 w-full bg-cover bg-center">
                    </div>
                    <div class="flex justify-center flex-col items-center">
                        <div class="w-36">
                            <img src="https://cdn3.iconfinder.com/data/icons/characters-2/100/character-03-512.png"
                                class="w-full h-36 bg-gray-100 border-2 rounded-lg border-white -mt-16" alt="">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-1 justify-center flex-col mt-5">
                        ...
                        <a href="{{ route('student.payments') }}"
                            class="bg-white w-full px-2 py-3 border-b flex items-center gap-3 hover:bg-slate-100 text-slate-700">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
