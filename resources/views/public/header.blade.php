...
<header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center ">
        ...
        <a class="mr-5 text-gray-900 hover:bg-teal-800 bg-teal-500 py-2 cursor-pointer rounded px-3 bx bxs-{{ $theme == 'dark' ? 'sun text-white' : 'moon' }}" style="cursor:pointer" id="theme-toggle"></a>

      </nav>
      <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Apply
